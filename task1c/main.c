...
void printSectionNames()
{
    ...
    num_of_section_headers = header->e_shnum;
//    Elf32_Shdr * sectionHeader = (Elf32_Shdr *)(header->e_shoff + header->e_entry);
    ...
    for (i=0; i< num_of_section_headers; i++)
    {
        ...
        printf("[%d]\t",i);                            //index
        printf("%d\t\t", sectionHeader->sh_name);      //section name
...
//    int shstrtabOffset = sectionHeader[header->e_shstrndx].sh_offset;
//    int shstrtabOffsetRel = shstrtabOffset - header->e_entry;;
//    num_of_section_headers = header->e_shnum;
//    //Relative offset
//
//
